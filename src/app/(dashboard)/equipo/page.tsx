          ...
          return (
            <label
              ...
              className={`flex items-start gap-3 rounded-lg border p-3 ${
                disabled
                  ? "cursor-not-allowed border-slate-100 dark:border-slate-600 opacity-60"
          ...
          <table className="w-full text-sm">
            ...
            <tbody>
              {miembrosVisibles.map((m) => (
                <tr key={m.id} className="border-b border-slate-100 dark:border-slate-600 last:border-0">
